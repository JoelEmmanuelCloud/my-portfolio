export const projects = [
  {
    ...
    impact: [
      "Real-time ride matching with optimized distance calculation",
      "Automated CI/CD pipeline with GitHub Actions and AWS CodeDeploy",
      "Scalable infrastructure handling production traffic",
      "Integrated payment processing and notification systems"
    ],
    technologies: {
      frontend: ["React", "JavaScript", "Tailwind CSS"],
      backend: ["Node.js", "Express", "MongoDB", "Socket.IO"],
      cloud: ["AWS EC2", "S3", "Redis", "GitHub Actions"],
  ...
  },
  {
    ...
    impact: [
      "Delivered scalable frontend components for AI workflows",
