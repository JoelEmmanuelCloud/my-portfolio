    ...
    <div className="min-h-screen pt-16 bg-white dark:bg-gray-900">
      ...
      <section className="py-6 sm:py-8 border-b border-black/10 dark:border-white/10">
        <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
          <Link
            href="/projects"
            className="inline-flex items-center text-black dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors font-medium text-sm sm:text-base"
          >
      ...
      <section className="py-12 sm:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
          <div className="max-w-5xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 mb-6 sm:mb-8 text-black dark:text-gray-300">
              ...
              {project.links?.live && (
                <a
                  ...
                  className="flex items-center gap-2 hover:text-blue-600 dark:hover:text-blue-400 transition-colors text-base sm:text-lg font-medium"
                >
                  Live Site
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-black dark:text-gray-300 leading-relaxed font-normal max-w-4xl">
              {project.summary}
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
          <div className="grid lg:grid-cols-3 gap-8 lg:gap-12 xl:gap-16">
            ...
            <div className="lg:col-span-2 space-y-10 sm:space-y-12 lg:space-y-16">
              ...
              {project.context && (
                <div>
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-medium text-black dark:text-white mb-4 sm:mb-6">
                    Context
                  </h2>
                ...
                <div>
                  ...
                  <div className="space-y-6 sm:space-y-8">
                    {Object.entries(project.technologies).map(([category, techs]) => (
                      <div key={category}>
                        <h3 className="font-medium text-black dark:text-white mb-3 sm:mb-4 text-base sm:text-lg lg:text-xl capitalize">
                ...
                <div>
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    {project.impact.map((item, index) => (
                      <div
                        key={index}
                        className="border-l-3 border-blue-600 pl-4 sm:pl-6 py-2 bg-blue-50/50 dark:bg-blue-900/10"
                      >
                        <p className="text-black dark:text-gray-300 leading-relaxed text-base sm:text-lg lg:text-xl">
                          {item}
                        </p>
            ...
            <div className="space-y-8 lg:space-y-12 lg:sticky lg:top-24 lg:self-start">
              ...
              <div className="bg-white dark:bg-gray-800 border border-black/10 dark:border-gray-700 rounded-xl p-6 sm:p-8 shadow-sm">
                <h3 className="font-medium text-black dark:text-white mb-4 sm:mb-6 text-lg sm:text-xl">
                  Technologies
                </h3>
                <div className="space-y-2 sm:space-y-3">
                  {project.stack.map((tech) => (
                    <div key={tech} className="text-black dark:text-gray-300 text-base sm:text-lg">
                      {tech}
                    </div>
                  ))}
                </div>
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    {project.links?.live && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-3 text-black dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors text-base sm:text-lg font-medium"
                      >
      ...
      {relatedProjects.length > 0 && (
        <section className="py-12 sm:py-16 lg:py-20 bg-gray-50 dark:bg-gray-800">
          <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-medium text-black dark:text-white mb-8 sm:mb-12 lg:mb-16">
              More Projects
            </h2>
                ...
                <div key={relatedProject.slug} className="group bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="space-y-0">
                    ...
                    <div className="p-6 sm:p-8">
                      <h3 className="text-xl sm:text-2xl font-medium text-black dark:text-white mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                        {relatedProject.title}
                      </h3>
                      <p className="text-black dark:text-gray-300 mb-3 text-base sm:text-lg font-medium">{relatedProject.role}</p>
                      <p className="text-black dark:text-gray-300 leading-relaxed text-base sm:text-lg mb-6 sm:mb-8">
